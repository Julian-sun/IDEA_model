...
# Run the method for 2025
df_results = run_exp(df, series='atend_ivas', year_min=2022, year_max=2024, year_actual=2025) # é so munar o nome da coluna e rodar para outras variáveis
